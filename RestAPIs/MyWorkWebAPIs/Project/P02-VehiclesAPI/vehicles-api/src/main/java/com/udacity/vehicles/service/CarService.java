...
public class CarService {
    ...
    public Car findById(Long id) {
         ...
         */
        Car car = new Car();
        car = repository.findById(id).orElseThrow(() -> new CarNotFoundException("Car with id " + id + " not found"));
        ...
        // Fetch and set the price for the car
    ...
    public Car save(Car car) {
        if (car.getId() != null) {
            System.out.println("Saved here "+ car.getId()+  ".....");
        ...
        System.out.println("Saved Successfully "+ car.getId()+  ".....");
    ...
    public void delete(Long id) {
         ...
         */
        System.out.println("Deleting from the database" + id + ".....");
